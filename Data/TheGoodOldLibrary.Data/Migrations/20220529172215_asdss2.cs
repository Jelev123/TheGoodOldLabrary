...
{
    public partial class asdss2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderedTimes = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PeriodicalCount = table.Column<int>(type: "int", nullable: false),
                    OrderedTimes = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Periodicals_Types_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeriodicalTakings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PeriodicalTakings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PeriodicalTakings_Periodicals_PeriodicalId",
                        column: x => x.PeriodicalId,
                        principalTable: "Periodicals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Periodicals_IsDeleted",
                table: "Periodicals",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Periodicals_TypeId",
                table: "Periodicals",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_PeriodicalTakings_IsDeleted",
                table: "PeriodicalTakings",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_PeriodicalTakings_PeriodicalId",
                table: "PeriodicalTakings",
                column: "PeriodicalId");

            migrationBuilder.CreateIndex(
                name: "IX_PeriodicalTakings_UserId",
                table: "PeriodicalTakings",
                column: "UserId");
